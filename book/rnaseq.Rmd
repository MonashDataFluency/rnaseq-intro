...
```{r echo=F, fig.cap = "[RNAseq data visualisation (follow a link for reference)](https://secure.clcbio.com/helpspot/index.php?pg=kb.page&id=380)"}
knitr::include_graphics("figures/igv_plot.jpg")
```
