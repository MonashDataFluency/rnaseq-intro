...
```{r echo=F, fig.cap = "End to end alignment"}
knitr::include_graphics("figures/aligner-end-to-end.png")
```
- soft-clipping: is when aligner allowed to disregard ends of the reads but still map the the bit in the middle of the read

```{r echo=F, fig.cap = "Soft clipping alignment"}
knitr::include_graphics("figures/aligner-soft-clipping.png")
```
...
```{r echo=F, fig.cap = "IGV browser view of one sample"}
knitr::include_graphics("figures/igv12.png")
```
...
```{r echo=F}
knitr::include_graphics("figures/rnaseq2.png")
```
...
```{r echo=F, fig.cap = "https://htseq.readthedocs.io/en/release_0.10.0/count.html"}
knitr::include_graphics("figures/count_modes.png")
```
